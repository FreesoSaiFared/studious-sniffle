...
require("context_bound_2mib", "2L*1024L*1024L" in context and "exceeds 2 MiB" in context, "context import must be bounded")
require("context_hash", "MessageDigest.getInstance(\"SHA-256\")" in context, "imported bytes must be hash addressed")
require("context_provenance", 'meta.put("sourceUri",uri.toString())' in context and 'meta.put("importedAtMs"' in context, "source provenance required")
